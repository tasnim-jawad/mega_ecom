<?php
namespace App\Modules\SalesManagement\SalesQuotationOrder\Database;
...
class Seeder extends SeederClass
{
     ...
     * Run the database seeds.
     php artisan db:seed --class="\App\Modules\SalesManagement\SalesQuotationOrder\Database\Seeder"
     */
