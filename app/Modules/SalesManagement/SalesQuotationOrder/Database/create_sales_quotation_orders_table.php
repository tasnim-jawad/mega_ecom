...
{
    /**
     php artisan migrate --path='\App\Modules\SalesManagement\SalesQuotationOrder\Database\create_sales_quotation_orders_table.php'
     * Run the migrations.
     */
    public function up(): void
    {
        Schema::create('sales_quotation_orders', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sales_quotation_orders');
    }
};
