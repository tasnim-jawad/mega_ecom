<?php
namespace App\Modules\SalesManagement\SalesInvoiceDetails\Database;
...
class Seeder extends SeederClass
{
     ...
     * Run the database seeds.
     php artisan db:seed --class="\App\Modules\SalesManagement\SalesInvoiceDetails\Database\Seeder"
     */
