...
{
    /**
     php artisan migrate --path='\App\Modules\SalesManagement\SalesReturn\Database\create_sales_return_orders_table.php'
     * Run the migrations.
     */
    public function up(): void
    {
        Schema::create('sales_return_orders', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sales_return_orders');
    }
};
