<?php
namespace App\Modules\SalesManagement\SalesQuotationOrderDetails\Database;
...
class Seeder extends SeederClass
{
     ...
     * Run the database seeds.
     php artisan db:seed --class="\App\Modules\SalesManagement\SalesQuotationOrderDetails\Database\Seeder"
     */
