...
{
    /**
     php artisan migrate --path='\App\Modules\SalesManagement\SalesQuotationOrderDetails\Database\create_sales_quotation_order_details_table.php'
     * Run the migrations.
     */
    public function up(): void
    {
        Schema::create('sales_quotation_order_details', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sales_quotation_order_details');
    }
};