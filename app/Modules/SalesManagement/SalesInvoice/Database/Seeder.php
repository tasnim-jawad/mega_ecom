<?php
namespace App\Modules\SalesManagement\SalesInvoice\Database;
...
class Seeder extends SeederClass
{
     ...
     * Run the database seeds.
     php artisan db:seed --class="\App\Modules\SalesManagement\SalesInvoice\Database\Seeder"
     */
    static $model = \App\Modules\SalesManagement\SalesInvoice\Models\Model::class;
