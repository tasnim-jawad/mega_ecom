                    ...
                    <div class="col-xl-7 col-md-5 col-sm-6">
                        <div class="top-header-right">
                            ...
                            <div class="language-block">
                                <div class="language-dropdown"> <span class="language-dropdown-click">
                                ...
                                <div class="curroncy-dropdown"> <span class="curroncy-dropdown-click">
                ...
                <div class="row">
                        ...
                        <div class="contact-block">
                            <div class="sm-nav-block">
                                <ul class="nav-slide">
                                    ...
                                    <li><a
                                            href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">western
                                            ware</a></li>
                                    <li><a
                                            href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">TV,
                                            Appliances</a></li>
                                    <li><a
                                            href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Pets
                                            Products</a></li>
                                    <li><a
                                            href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Car,
                                            Motorbike</a></li>
                                    <li><a
                                            href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Industrial
                                            Products</a></li>
                                    <li><a
                                            href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Beauty,
                                            Health Products</a></li>
                                    <li><a
                                            href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Grocery
                                            Products </a></li>
                                    <li><a
                                            href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Sports</a>
                                    </li>
                                    <li><a
                                            href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Bags,
                                            Luggage</a></li>
                                    <li><a
                                            href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Movies,
                                            Music </a></li>
                                    <li><a
                                            href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Video
                                            Games</a></li>
                                    <li><a
                                            href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Toys,
                                            Baby Products</a></li>
                                ...
                                <ul>
                                    <li>
                                        <div class="contact-item-main">
                                            <svg enable-background="new 0 0 511.999 511.999"
                                                viewBox="0 0 511.999 511.999" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path
                                                    ...
                                                    <path
                                                        d="m301.999 0c-8.284 0-15 6.716-15 15s6.716 15 15 15c99.252 0 180 80.748 180 180 0 8.284 6.716 15 15 15s15-6.716 15-15c0-115.794-94.206-210-210-210z">
                                                    </path>
                                                    <path
                                                        d="m301.998 209.986s.001.005.001.014c0 8.284 6.716 15 15 15s15-6.716 15-15c0-16.542-13.458-30-30-30-8.284 0-15 6.709-15 14.993s6.715 14.993 14.999 14.993z">
                                                    </path>
                                                    <path
                                                        d="m301.999 150c33.084 0 60 26.916 60 60 0 8.284 6.716 15 15 15s15-6.716 15-15c0-49.626-40.374-90-90-90-8.284 0-15 6.716-15 15s6.716 15 15 15z">
                                                    </path>
                                                    <path
                    ...
                    <div class="col-4">
                        <div class="logo-block">
                            <Link href="/">
                                <img src="frontend/assets/images/logo.png" alt="logo" class="img-fluid  ">
                            </Link>
                        </div>
                    </div>
                    <div class="col-4">
                          ...
                          c-57.897,0-105-47.103-105-105c0-57.897,47.103-105,105-105c57.897,0,105,47.103,105,105C361,192.897,313.897,240,256,240z">
                           ...
                           M451.001,482H451H61v-71.363C96.031,360.683,152.952,331,214.167,331h83.667c61.215,0,118.135,29.683,153.167,79.637V482z">
                                ...
                                <li class="mobile-search">
                                    <a href="javascript:void(0)">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="612.01px"
                                            height="612.01px" viewBox="0 0 612.01 612.01"
                                ...
                                <li class="mobile-cart item-count" onclick="openCart()">
                                    <a href="javascript:void(0)">
                                        <div class="cart-item-main">
                                            ...
                                            <div class="cart-item">
                                                <div>shopping<span>cart</span></div>
                                            </div>
                                        </div>
                                        <div class="item-count-contain"> 3 </div>
                                    </a>
                        ...
                        <div class="navbar-menu">
                            <div class="category-left">
                                ...
                                <div class="logo-block logo-sm-center ">
                                    <a href="https://themes.pixelstrap.com/bigdeal/html/index.html">
                                        <img src="/frontend/assets/images/logo.png" alt="logo" class="img-fluid  ">
                                    </a>
                                </div>
                                <div class=" nav-block">
                                    <div class="nav-left">
                                        <nav class="navbar" data-bs-toggle="collapse"
                                            ...
                                            <button class="navbar-toggler" type="button"> <span class="navbar-icon"><i
                                        ...
                                        <div class="collapse show nav-desk" id="navbarToggleExternalContent">
                                            <div class="header-category">
                                                <ul class="collapse-category show">
                                                    ...
                                                    <li><a href="category-page(left-sidebar).html"><img
                                                                src="https://themes.pixelstrap.com/bigdeal/assets/images/mega-store/header-category/1.png"
                                                                alt="">furniture</a></li>
                                                    <li><a href="category-page(left-sidebar).html"><img
                                                                src="https://themes.pixelstrap.com/bigdeal/assets/images/mega-store/header-category/2.png"
                                                                alt="">electronics</a></li>
                                                    <li><a href="category-page(left-sidebar).html"><img
                                                                src="https://themes.pixelstrap.com/bigdeal/assets/images/mega-store/header-category/3.png"
                                                                alt="">fashion</a></li>
                                                    <li><a href="category-page(left-sidebar).html"><img
                                                                src="https://themes.pixelstrap.com/bigdeal/assets/images/mega-store/header-category/4.png"
                                                                alt="">medicine</a></li>
                                                    <li><a href="category-page(left-sidebar).html"><img
                                                                src="https://themes.pixelstrap.com/bigdeal/assets/images/mega-store/header-category/6.png"
                                                                alt="">cosmetic</a></li>
                                                    <li><a href="category-page(left-sidebar).html"><img
                                                                src="https://themes.pixelstrap.com/bigdeal/assets/images/mega-store/header-category/7.png"
                                                                alt="">bycycle</a></li>
                                                    <li><a href="category-page(left-sidebar).html"><img
                                                                src="https://themes.pixelstrap.com/bigdeal/assets/images/mega-store/header-category/8.png"
                                                                alt="">shoes</a></li>
                                                    <li><a href="category-page(left-sidebar).html"><img
                                                                src="https://themes.pixelstrap.com/bigdeal/assets/images/mega-store/header-category/9.png"
                                                                alt="">sport</a></li>
                                                    <li><a href="category-page(left-sidebar).html"><img
                                                                src="https://themes.pixelstrap.com/bigdeal/assets/images/mega-store/header-category/10.png"
                                                                alt="">gym</a></li>
                                                    <li><a href="category-page(left-sidebar).html"><img
                                                                src="https://themes.pixelstrap.com/bigdeal/assets/images/mega-store/header-category/11.png"
                                                                alt="">grocery</a></li>
                                                </ul>
                                            </div>
                                            ...
                                            <ul class="nav-cat title-font">
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">speakers</a>
                                                </li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Garden
                                                        &amp; Outdoors</a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Home
                                                        Furnishing</a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">DSLR
                                                        Cameras</a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Refrigerators</a>
                                                </li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Bags
                                                        &amp; Luggage</a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Children's
                                                        Books </a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Western
                                                        Wear</a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Travel
                                                        Accessories</a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Birthday
                                                        Gift Cards</a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Dog
                                                        supplies</a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Gaming
                                                        Consoles</a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Kitchen
                                                        &amp; Dining</a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Car
                                                        Electronics</a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Washing
                                                        Machines</a></li>
                                                <li><a
                                                        href="https://themes.pixelstrap.com/bigdeal/html/category-page(left-sidebar).html">Echo
                                                        Plus</a></li>
                                                <li>
                                                ...
                                                <li> <a class="mor-slide-click">mor category <i
                            ...
                            <div class="menu-block">
                                ...
                                <ul id="main-menu" class="sm pixelstrap sm-horizontal"
                                    data-smartmenus-id="17161987108250127">
                                    <li>
                                    ...
                                    <!--HOME-->
                                    <li>
                                        <Link href="/" class="light-menu-item has-submenu"
                                            id="sm-17161987108250127-1" aria-haspopup="true"
                                            aria-controls="sm-17161987108250127-2" aria-expanded="false">Home<span
                                                ></span></Link>
                                    ...
                                    <!--product-meu start-->
                                    <li class="mega">
                                        <Link class="light-menu-item has-submenu" href="/products"
                                            id="sm-17161987108250127-5" aria-haspopup="true"
                                            aria-controls="sm-17161987108250127-6" aria-expanded="false">product
                                            </Link>

                                    </li>
                                    <li class="mega">
                                        <Link class="light-menu-item has-submenu" href="/product-details/slug"
                                            id="sm-17161987108250127-5" aria-haspopup="true"
                                            aria-controls="sm-17161987108250127-6" aria-expanded="false">product details
                                            </Link>
                                    ...
                                    <!--mega-meu start-->
                                    <li class="mega">
                                        <Link class="light-menu-item has-submenu" href="/cart"
                                            id="sm-17161987108250127-7" aria-haspopup="true"
                                            aria-controls="sm-17161987108250127-8" aria-expanded="false">Cart</Link>
                                    ...
                                    <!--pages meu start-->
                                    <li>
                                        <Link class="light-menu-item has-submenu" href="checkout"
                                            id="sm-17161987108250127-9" aria-haspopup="true"
                                            aria-controls="sm-17161987108250127-10" aria-expanded="false">Chackout</Link>
                            ...
                            <div class="category-right">
                                <div class="btn-group">
                                    <div class="gift-block" data-bs-toggle="dropdown">
                                        <div class="grif-icon"> <i class="icon-gift"></i> </div>
                                    ...
                                    <div class="dropdown-menu gift-dropdown">
                                        <div class="media">
                                            <div class="me-3"> <img src="frontend/assets/images/1.png"
                                                    alt="Generic placeholder image"> </div>
                                            <div class="media-body">
                                                <h5 class="mt-0">Billion Days</h5>
                                                <p><img src="frontend/assets/images/currency.png" class="cash"
                                                        alt="gift"> Flat
                                                    Rs. 270 Rewards</p>
                                            </div>
                                        </div>
                                        <div class="media">
                                            <div class="me-3"> <img src="frontend/assets/images/2.png"
                                                    alt="Generic placeholder image"> </div>
                                            <div class="media-body">
                                                <h5 class="mt-0">Fashion Discount</h5>
                                                <p><img src="frontend/assets/images/fire.png" class="fire"
                                                        alt="gift">Extra 10%
                                                    off (upto Rs. 10,000*) </p>
                                            </div>
                                        </div>
                                        <div class="media">
                                            <div class="me-3"> <img src="frontend/assets/images/3.png"
                                                    alt="Generic placeholder image"> </div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="me-3"> <img src="frontend/assets/images/6.png"
                                                    alt="Generic placeholder image"> </div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="me-3"> <img src="frontend/assets/images/5.png"
                                                    alt="Generic placeholder image"> </div>
                                            <div class="media-body">
