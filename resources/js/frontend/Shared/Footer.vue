                            ...
                            <div class="footer-box">
                                ...
                                <div class="footer-contant">
                                    <ul class="contact-list">
                                        <li>
                                            <i class="fa fa-map-marker"></i>ETEK
                                            BD <br />
                                            bangladesh-<span>3654123</span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <i class="fa fa-envelope-o"></i>email us: support@etek.com.bd
                                        </li>
                                        <li>
                    ...
                    <div class="offer-content">
                        ...
                        <div>
                            <div>
                                ...
                                <div class="timer">
                                    <p id="demo4">
                                        <span>126<span class="timer-cal">Days</span></span><span>6<span
                                                class="timer-cal">Hrs</span></span><span>22<span
                                                class="timer-cal">Min</span></span><span>53<span
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-xs-12">
                            <div class="quick-view-img bg-size" style="
                                    background-image: url('../assets/images/layout-1/product/3.jpg');
                                    ...
                                    <div class="modal fade" id="sizemodal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img src="/frontend/assets/images/size-chart.jpg" alt=""
                                                        class="img-fluid" />
                                                </div>
                                            </div>
                                        </div>
