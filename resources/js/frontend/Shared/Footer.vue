              ...
              <div class="footer-box">
                ...
                <div class="footer-contant">
                  <div class="footer-logo">
                    <a href="https://themes.pixelstrap.com/bigdeal/html/index.html"> <img src="frontend/assets/images/logo(1).png" class="img-fluid" alt="logo"> </a>
                  </div>
              ...
              <div class="footer-box">
                ...
                <div class="footer-contant">
                  <div class="newsletter-second">
                    ...
                    <div class="form-group"> <a href="javascript:void(0)" class="btn btn-solid btn-sm">submit now</a> </div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="footer-right">
              <ul class="payment">
                <li>
                  <a href="javascript:void(0)"><img src="frontend/assets/images/1(7).png" class="img-fluid" alt="pay"></a>
                </li>
                <li>
                  <a href="javascript:void(0)"><img src="frontend/assets/images/2(7).png" class="img-fluid" alt="pay"></a>
                </li>
                <li>
                  <a href="javascript:void(0)"><img src="frontend/assets/images/3(7).png" class="img-fluid" alt="pay"></a>
                </li>
                <li>
                  <a href="javascript:void(0)"><img src="frontend/assets/images/4(4).png" class="img-fluid" alt="pay"></a>
                </li>
                <li>
                  <a href="javascript:void(0)"><img src="frontend/assets/images/5(5).png" class="img-fluid" alt="pay"></a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="modal-body">
          <div class="news-latter">
            <div class="modal-bg">
              ...
              <div class="imd-wrraper bg-size" style="background-image: url(&quot;../frontend/assets/images/2.jpg&quot;); background-size: cover; background-position: center center; display: block;">
                  <img src="frontend/assets/images/2(8).jpg" alt="newsletterimg" class="img-fluid bg-img" style="display: none;">
              </div>
              </div>
            </div>
          </div>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-lg-6 col-xs-12">
              <div class="quick-view-img bg-size" style="background-image: url(&quot;../assets/images/layout-1/product/3.jpg&quot;); background-size: cover; background-position: center center; display: block;">
                <img src="frontend/assets/images/3(8).jpg" alt="" class="img-fluid bg-img" style="display: none;">
              </div>
            </div>
              ...
              <div class="product-right">
                <div class="pro-group">
                  ...
                  <div class="revieu-box">
                    ...
                    <a href="https://themes.pixelstrap.com/bigdeal/html/review.html"><span>(6 reviews)</span></a>
                  </div>
                ...
                <div class="pro-group pb-0">
                  ...
                  <a href="https://themes.pixelstrap.com/bigdeal/html/layout-4.html" data-bs-toggle="modal" data-bs-target="#sizemodal">size chart</a></span></h6>
                  ...
                  <div class="product-buttons">
                    ...
                    <a href="https://themes.pixelstrap.com/bigdeal/html/product-page(left-sidebar).html" class="btn btn-normal tooltip-top" data-tippy-content="view detail">
                      view detail
                    </a>
                  </div>
                </div>
        ...
        <div class="modal-body">
          ...
          <div class="pro-group mb-0">
            <div class="modal-btn">
              ...
              <a href="https://themes.pixelstrap.com/bigdeal/html/product-page(left-sidebar).html" class="btn btn-solid btn-sm">
                more detail
              </a>
            </div>
          </div>
    ...
    <div class="cart-inner">
      ...
      <div class="cart_media">
        ...
        <ul class="cart_total">
          ...
          <li>
            <div class="buttons">
              <a href="https://themes.pixelstrap.com/bigdeal/html/cart.html" class="btn btn-solid btn-sm">view cart</a>
              <a href="https://themes.pixelstrap.com/bigdeal/html/checkout.html" class="btn btn-solid btn-sm ">checkout</a>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="cart-inner">
      ...
      <div class="cart_media">
        ...
        <ul class="cart_total">
          ...
          <li>
            <div class="buttons">
              <a href="https://themes.pixelstrap.com/bigdeal/html/wishlist.html" class="btn btn-solid btn-block btn-md">view wislist</a>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="cart-inner">
      ...
      <form class="theme-form">
        ...
        <div class="accout-fwd">
          <a href="https://themes.pixelstrap.com/bigdeal/html/forget-pwd.html" class="d-block"><h5>forget password?</h5></a>
          <a href="https://themes.pixelstrap.com/bigdeal/html/register.html" class="d-block"><h6>you have no account ?<span>signup now</span></h6></a>
        </div>
      </form>
    </div>
  </div>
