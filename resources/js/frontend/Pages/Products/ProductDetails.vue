                    ...
                    <div class="row">
                        <div class="col-sm-3 collection-filter">
                            ...
                            <div class="theme-card creative-card creative-inner">
                                ...
                                <div class="slide-1 slick-initialized slick-slider"><button
                                        class="slick-prev slick-arrow" aria-label="Previous" type="button"
                                        style="display: block;">Previous</button>
                                    <div class="slick-list draggable">
                                        <div class="slick-track"
                                            style="opacity: 1; width: 1834px; transform: translate3d(-262px, 0px, 0px);">
                                            <div class="slick-slide slick-cloned" data-slick-index="-1"
                                                aria-hidden="true" tabindex="-1" style="width: 262px;">
                                                <div>
                                                        ...
                                                        <div class="media-banner plrb-0 b-g-white1 border-0">
                                                            <div class="media-banner-box">
                                                                <div class="media">
                                                                    <a href="product-page(left-sidebar).html"
                                                                        tabindex="-1">
                                                                        <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/media-banner/1.jpg"
                                                                                ...
                                                                                <div class="cart-info">
                                                                                    ...
                                                                                    <a href="javascript:void(0)"
                                                                                        ...
                                                                                        tabindex="-1"><svg
                                                                                            ...
                                                                                            stroke-linecap="round"
                                                                                            stroke-linejoin="round"
                                                                                            class="feather feather-heart add-to-wish">
                                                                                            <path
                                                            ...
                                                            <div class="media-banner-box">
                                                                <div class="media">
                                                                    <a href="product-page(left-sidebar).html"
                                                                        tabindex="-1">
                                                                        <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/media-banner/2.jpg"
                                                                            class="img-fluid " alt="banner">
                                                                    </a>
                                                                    <div class="media-body">
                                                                        <div class="media-contant">
                                                            ...
                                                            <div class="media-banner-box">
                                                                <div class="media">
                                                                    <a href="product-page(left-sidebar).html"
                                                                        tabindex="-1">
                                                                        <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/media-banner/3.jpg"
                                                                            class="img-fluid " alt="banner">
                                                                    </a>
                                                                    <div class="media-body">
                                                                        <div class="media-contant">
                                            ...
                                            <div class="slick-slide slick-current slick-active" data-slick-index="0"
                                                aria-hidden="false" style="width: 262px;">
                                                <div>
                                                    <div style="width: 100%; display: inline-block;">
                                                        <div class="media-banner plrb-0 b-g-white1 border-0">
                                                            <div class="media-banner-box">
                        ...
                        <div class="col-lg-9 col-sm-12 col-xs-12">
                            <div class="container-fluid">
                                ...
                                <div class="row ">
                                    <div class="col-lg-5">
                                        <div class="product-slick  slick-initialized slick-slider"><button
                                                class="slick-prev slick-arrow" aria-label="Previous" type="button"
                                                style="display: block;">Previous</button>
                                            <div class="slick-list draggable">
                                                    ...
                                                    <div class="slick-list draggable">
                                                        <div class="slick-track"
                                                            ...
                                                            <div class="slick-slide" data-slick-index="0"
                                                                aria-hidden="true" style="width: 134px;" tabindex="-1">
                                                                <div>
                                                                    <div style="width: 100%; display: inline-block;">
                                        ...
                                        <div class="product-right ">
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body"><img
                                                                    src="https://themes.pixelstrap.com/bigdeal/assets/images/size-chart.jpg"
                                                                    alt="" class="img-fluid "></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="pro-group">
                                                ...
                                                <div class="delivery-detail">
                                                    <div class="delivery-detail-contian">
                                                        ...
                                                        <a href="javascript:void(0)"
                                                            class="btn btn-solid btn-md ">check</a>
                                                    </div>
                                                            ...
                                                            <g>
                                                                <g>
                                                                    <path
                                                                        ...
                                                                        fill="#cce6ff"></path>
                                                                    <path d="m332 234.944h180v158.722h-180z"
                                                                        fill="#cc295f"></path>
                                                                </g>
                                                                <g>
                                                                    <path
                                            ...
                                            <div class="pro-group">
                                                <div class="product-offer">
                                                    <h6 class="product-title"><i class="fa fa-tags"></i>5 offers
                                                        Available </h6>
                                                    <div class="offer-contain">
                                                        ...
                                                        <ul class="offer-sider">
                                                            ...
                                                            <li>
                                                                <span class="code-lable">OFFER40</span>
                                                                <div>
                                                                    <h5>Bank Offer40% Unlimited Cashback on bideal Axis
                                                                        Bank Credit Card</h5>
                                                                    <p>Use code "OFFER40" Min. Cart Value $99 | Max.
                                                                        Discount $40</p>
                                                                </div>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div>
                                                                    <h5>Bank Offer10% off* with Axis Bank Buzz Credit
                                                                        Card</h5>
                                                            ...
                                                            <li>
                                                                ...
                                                                <div>
                                                                    <h5>Bank Offer5% Unlimited Cashback on bideal sbi
                                                                        banck Credit Card</h5>
                                                                    <p>Use code "OFFER5" Min. Cart Value $99 | Max.
                                                                        Discount $5</p>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                        <h5 class="show-offer"><span class="more-offer">show more
                                                                offer</span><span class="less-offer">less offer</span>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-lg-12">
                                        <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                            <li class="nav-item"><a class="nav-link" id="top-home-tab"
                                        ...
                                        <div class="tab-content nav-material" id="top-tabContent">
                                            ...
                                            <div class="tab-pane fade active show" id="top-profile" role="tabpanel"
                                                ...
                                                <p class="ps-0">Lorem Ipsum is simply dummy text of the printing and
            ...
            <div class="custom-container">
                ...
                <div class="row">
                    <div class="col-12 product">
                        <div class="product-slide-6 product-m no-arrow slick-initialized slick-slider"><button
                                class="slick-prev slick-arrow" aria-label="Previous" type="button"
                                style="display: inline-block;">Previous</button>
                            <div class="slick-list draggable">
                                <div class="slick-track"
                                    style="opacity: 1; width: 5016px; transform: translate3d(-1320px, 0px, 0px);">
                                    <div class="slick-slide slick-cloned" data-slick-index="-5" aria-hidden="true"
                                        tabindex="-1" style="width: 264px;">
                                        <div>
                                            <div style="width: 100%; display: inline-block;">
                                                    ...
                                                    <div class="product-imgbox">
                                                        <div class="product-front">
                                                            <a href="product-page(left-sidebar).html" tabindex="-1">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/4.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-back">
                                                            <a href="product-page(left-sidebar).html" tabindex="-1">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/a4.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-icon icon-inline">
                                                            <button data-bs-toggle="modal" data-bs-target="#addtocart"
                                                                class="tooltip-top" data-tippy-content="Add to cart"
                                                                tabindex="-1">
                                                            ...
                                                            <a href="javascript:void(0)" class="add-to-wish tooltip-top"
                                                                data-tippy-content="Add to Wishlist" tabindex="-1">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                                    stroke="currentColor" stroke-width="2"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                            ...
                                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                                                ...
                                                                data-tippy-content="Quick View" tabindex="-1">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                                    stroke="currentColor" stroke-width="2"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                            ...
                                                            <a href="compare.html" class="tooltip-top"
                                                                data-tippy-content="Compare" tabindex="-1">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                                    stroke="currentColor" stroke-width="2"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <div style="width: 100%; display: inline-block;">
                                                <div class="product-box">
                                                    <div class="product-imgbox">
                                                        <div class="product-front">
                                                            <a href="product-page(left-sidebar).html" tabindex="-1">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/5.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-back">
                                                            <a href="product-page(left-sidebar).html" tabindex="-1">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/a5.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-icon icon-inline">
                                            ...
                                            <div style="width: 100%; display: inline-block;">
                                                <div class="product-box">
                                                    <div class="product-imgbox">
                                                        <div class="product-front">
                                                            <a href="product-page(left-sidebar).html" tabindex="-1">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/6.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-back">
                                                            <a href="product-page(left-sidebar).html" tabindex="-1">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/a6.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-icon icon-inline">
                                            ...
                                            <div style="width: 100%; display: inline-block;">
                                                <div class="product-box">
                                                    <div class="product-imgbox">
                                                        <div class="product-front">
                                                            <a href="product-page(left-sidebar).html" tabindex="-1">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/7.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-back">
                                                            <a href="product-page(left-sidebar).html" tabindex="-1">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/a7.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-icon icon-inline">
                                            ...
                                            <div style="width: 100%; display: inline-block;">
                                                <div class="product-box">
                                                    <div class="product-imgbox">
                                                        <div class="product-front">
                                                            <a href="product-page(left-sidebar).html" tabindex="-1">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/8.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-back">
                                                            <a href="product-page(left-sidebar).html" tabindex="-1">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/a8.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-icon icon-inline">
                                    ...
                                    <div class="slick-slide slick-current slick-active" data-slick-index="0"
                                        aria-hidden="false" style="width: 264px;">
                                        <div>
                                            <div style="width: 100%; display: inline-block;">
                                                <div class="product-box">
                                                    <div class="product-imgbox">
                                                        <div class="product-front">
                                                            <a href="product-page(left-sidebar).html" tabindex="0">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/1.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-back">
                                                            <a href="product-page(left-sidebar).html" tabindex="0">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/a1.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-icon icon-inline">
                                                            ...
                                                            <a href="javascript:void(0)" class="add-to-wish tooltip-top"
                                                                data-tippy-content="Add to Wishlist" tabindex="0">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                                    stroke="currentColor" stroke-width="2"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                            ...
                                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                                                data-bs-target="#quick-view" class="tooltip-top"
                                                                data-tippy-content="Quick View" tabindex="0">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                                    stroke="currentColor" stroke-width="2"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                                            ...
                                                            <a href="compare.html" class="tooltip-top"
                                                                data-tippy-content="Compare" tabindex="0">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                                    stroke="currentColor" stroke-width="2"
                                                                    stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <div style="width: 100%; display: inline-block;">
                                                <div class="product-box">
                                                    <div class="product-imgbox">
                                                        <div class="product-front">
                                                            <a href="product-page(left-sidebar).html" tabindex="0">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/3.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-back">
                                                            <a href="product-page(left-sidebar).html" tabindex="0">
                                                                <img src="https://themes.pixelstrap.com/bigdeal/assets/images/layout-2/product/a3.jpg"
                                                                    class="img-fluid  " alt="product">
                                                            </a>
                                                        </div>
                                                        <div class="product-icon icon-inline">
